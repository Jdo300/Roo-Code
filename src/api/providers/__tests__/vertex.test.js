...
describe("VertexHandler", () => {
	...
	describe("createMessage", () => {
		...
		it("should handle streaming responses correctly for Claude", async () => {
			...
			handler["anthropicClient"].messages.create = mockCreate
	...
	describe("thinking model configuration", () => {
		it("should configure thinking for models with :thinking suffix", () => {
			...
			const thinkingConfig = modelInfo.thinking
		...
		it("should calculate thinking budget correctly", () => {
			...
			expect(handlerWithBudget.getModel().thinking.budget_tokens).toBe(5000)
			...
			expect(handlerWithDefaultBudget.getModel().thinking.budget_tokens).toBe(8000) // 80% of 10000
			...
			expect(handlerWithSmallMaxTokens.getModel().thinking.budget_tokens).toBe(1024)
		})
		it("should pass thinking configuration to API", async () => {
			...
			thinkingHandler["anthropicClient"].messages.create = mockCreate
