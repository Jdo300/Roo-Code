...
export async function parseSourceCodeDefinitionsForFile(filePath, rooIgnoreController) {
...
export async function parseSourceCodeForDefinitionsTopLevel(dirPath, rooIgnoreController) {
 ...
 * @returns A formatted string with code definitions or null if no definitions found
 */
async function parseFile(filePath, languageParsers, rooIgnoreController) {
