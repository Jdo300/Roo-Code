...
export class TerminalRegistry {
	 ...
	 */
	static getTerminalByVSCETerminal(terminal) {
	 ...
	 */
	static getUnretrievedOutput(terminalId) {
	 ...
	 */
	static isProcessHot(terminalId) {
		const terminal = this.getTerminal(terminalId)
		if (!terminal) {
			return false
		}
...
`
	 ...
	 */
	static async getOrCreateTerminal(cwd, requiredCwd = false, taskId) {
